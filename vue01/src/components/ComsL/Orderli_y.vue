<template>
  ...
  <section class="title_y">
    ...
    <header id="head_top_y">
      <span>
      <section @click="back" class="head_nav_y">
          ...
          <section class="orderli_p_y">
            ...
            <router-link :to="{}" class="as_y">
              <header class="orderli_header_y">
                ...
                <p class="orderli_timeout_y" :class="minss==0&&secondss==0&&secondss==0?{cs_y:'支付超时'}:{cs_y:'等待支付'}">
                  {{cs_y}}</p>
              </header>
            </router-link>
            <!--名字.价钱-->
            ...
            <div class="orderli_again_y " @click="isshows = !isshows">
              <router-link :to="{}" :class="minss==0&&secondss==0&&secondss==0?{orderli_blue_y:true}:{orange_y:true}">
                去支付(还剩{{minss}}分{{secondss}}{{seconds}}秒)
              </router-link>
            </div>
          </section>
        </li>
