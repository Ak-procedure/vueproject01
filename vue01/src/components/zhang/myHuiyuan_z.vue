<template>
  <div id="mine_z">
    ...
    <div class="myde_z">
      ...
      <span class="text_z">会员中心</span>
    </div>

    <div>
      <p class="buy_for">为账户<span>{{users.username}}</span> 购买会员</p>
      <div class="vip_prerogative">
        <router-link :to="{path:'/HYYHshuoming'}" class="header_style">
      ...
      <router-link :to="{path:'/gmjl'}"  class="header_style common_style">
