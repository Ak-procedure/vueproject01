  ...
  <div id="mine_z">
    ...
    <div id="YHQ" v-if="showOrNot">
      ...
      <div class="hongbao_footer">
        <router-link :to="{path:'/duihuanhongbao'}"  href="#/benefit/exchange" class="hongbao_style" style="border-right: 1px solid rgb(245, 245, 245);">兑换红包</router-link>
    ...
    <div id="Daijinquan" v-else>
      ...
      <div class="unable_use">
        ...
        <p>无法使用代金券</p>
        <p>非客户端或客户端版本过低</p>
        <router-link :to="{path:'/DownLoad'}" href="#/download" class="download_app">
          下载或升级客户端
        </router-link>
      </div>
    </div>
