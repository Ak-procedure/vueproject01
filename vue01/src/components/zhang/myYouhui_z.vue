<template>
  <div id="mine_z">
    ...
    <div class="category_title">
      <span  @click="change" >
       <span :class="{line1:itrue}">红包</span>
      </span>
      <span @click="change2">
        <span :class="{line1:!itrue}">商家代金券</span>
      </span>
    </div>
    <!--三个优惠券-->
    <div id="YHQ" v-if="showOrNot">
      <div class="hongbao_container">
        <div  class="hongbao_title">
          ...
          <div class="hongbao_description">
            ...
            <router-link :to="{path:'/HBshuoming'}"  class="hongbao_detail">红包说明</router-link>
          </div>
        </div>
      ...
      <router-link :to="{path:'/lishihongbao'}"  class="history_hongbao">
        <span  class="check_history">查看历史红包</span>
      </router-link>
      <div class="hongbao_footer">
        <router-link :to="{path:'/duihuanhongbao'}"   class="hongbao_style" style="border-right: 1px solid rgb(245, 245, 245);">兑换红包</router-link>
        <router-link :to="{path:'/tuijian'}"  class="hongbao_style">推荐有奖</router-link>
      </div>
    </div>
    <!--代金券-->
    <div id="Daijinquan" v-else>
      <div class="description_z">
        <img src="data:image/png;base64,">
        <router-link :to="{path:'/shuoming'}"   class="hongbao_detail">商家代金券说明</router-link>
      </div>
      <div class="unable_use">
        ...
        <p>无法使用代金券</p>
        <p>非客户端或客户端版本过低</p>
        <router-link :to="{path:'/DownLoad'}" class="download_app">
          下载或升级客户端
        </router-link>
      </div>
    </div>
...
<style scoped>
  ...
  li {
    background: #fff url('../../assets/imgs/line.png') repeat-x;
