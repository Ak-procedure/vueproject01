<template>
    <div id="mine_z">
      ...
      <div class="friends_z" @click="changeS">
        <div>
      ...
      <div class="invite_num">
        <div class="invite_num_01">
          <p>累计收益</p>
          <p><span data-v-1859df90="">0</span>元</p>
        </div>
        <div class="invite_num_02">
          <p>成功邀请</p>
          <p><span>0</span>人</p>
        </div>
      </div>
