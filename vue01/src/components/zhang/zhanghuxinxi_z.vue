<template>
  <div id="mine_z">
    ...
    <div class="profile-info">
      ...
      <router-link :to="{}"  href="#/profile/info/setusername" class="info-router">
        <div class="headportrait headportraitwo">
          <h2>用户名</h2>
          <div class="headportrait-div">
            <router-link :to="{}"class="pointR_z"> <p>2432</p> ></router-link>
          </div>
        </div>
      </router-link>
      ...
      <router-link :to="{}"  href="#/forget" class="info-router">
        <div  class="headportrait headportraitwo headportraithree">
          <h2>登录密码</h2>
          <div class="headportrait-div">
            <p>修改</p>
