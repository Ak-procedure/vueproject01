...
import Fapiao from '../components/ComsL/FaPiao'
import  DingDanBZ from '../components/ComsL/DingDabBeiZhu'
import HYYHshuoming from '../components/zhang/HYYHshuoming'//会员优惠说明
import JFshuoming from '../components/zhang/JFshuoming'//积分说明
import YEshuoming from '../components/zhang/YEshuoming'//余额说明
...
import Gmjl from '../components/zhang/GMjilu'
 export default new Router({
  routes: [
    ...
    {path:'/dingdanbeizhu',component:DingDanBZ},
    {path:'/shuoming',component:shuoming},
    {path:'/HBshuoming',component:HBshuoming},
